<template>
    <view class="chatBox">
        <view class="scrollView">
            ...
            <scroll-view :scroll-top="scrollTop" :show-scrollbar="false" @scroll="scroll" @scrolltolower="lower"
                         @scrolltoupper="upper"
                    ...
                    <view class="chatLeft" v-if="item.sign !=userInfoSign">
                        ...
                        <u-row gutter="16" style="margin-top: 10rpx">
                            ...
                            <u-col offset="1.2" span="9.5">
                                ...
                                <img :src="item.content" class="leftContent" style="width: 100px;height: 100px;"
                                     v-if="item.chatType == 1"></img>
                                <video :src="item.content" @error="videoErrorCallback" class="leftContent" controls
                                       style="width: 100px;height: 100px;" v-if="item.chatType == 3"></video>
                                <rich-text :nodes="item.content" class="leftContent"
                                           v-if="item.chatType == 0"></rich-text>
                            </u-col>
                        </u-row>
                    ...
                    <view class="chatRight" v-if="item.type =='my'">
                        ...
                        <u-row gutter="20" style="margin-top: 10rpx">
                            ...
                            <u-col offset="0.67" span="8">
                                ...
                                <video :src="item.content" @error="videoErrorCallback" class="rightContent" controls
                                       style="width: 100px;height: 100px;" v-if="item.chatType == 3"></video>
                                <img :src="item.content" class="rightContent" style="width: 100px;height: 100px;"
                                     v-if="item.chatType == 1"></img>
                                <rich-text :nodes="item.content" class="rightContent"
                                           v-if="item.chatType == 0"></rich-text>
                            </u-col>
        ...
        <view class="chatFlooter" v-if="sys ==0">
            ...
            <view class="textArea">
                ...
                <textarea :auto-height="autoHeight" :show-confirm-bar="false" cursor-spacing="10px" maxlength="140"
                          placeholder="请输入" v-model="chatMessage"></textarea>
        ...
        <view class="chatFlooter" v-if="sys ==1">
            ...
            <view class="textArea">
                ...
                <textarea :auto-height="autoHeight" :show-confirm-bar="false" cursor-spacing="10px" maxlength="140"
                          placeholder="请输入" v-if="textAreaShow == 0" v-model="chatMessage"></textarea>
                <view class="textarea" v-if="textAreaShow == 1" v-model="chatMessage"></view>
            </view>
        ...
        <u-popup :mask="true" :mask-close-able="true" @close="emojiClose" class="emojiClass" height="250" mode="bottom"
                 style="z-index: 3" v-model="emojiShow">

            <view :key="index" style="height: 30px;width: 30px;float: left;margin-left: 2.5rpx;"
                  v-for="(item,index) in emojiJs">
                <!--									{{item.src}}-->
                <image :src="item.src" @click="chooseEmojiLeft(index)"
                       style="height: 30px;width: 30px;float: left"></image>
            </view>
