            ...
            <view class="header-Info">
                <view class="notice" @click="toReadNotive">
                    <view class="notice_box">
                        <view class="noticeIcon"><image src="/static/images/notice.png" class="auto-img"></image></view>
                ...
                <view class="avatar_nickName">
                    <view class="item avatarItem" @click="toEditDetail(userInfo)">
                        ...
                        <view class="avatar">
                            <image :src="userInfo.pic?userInfo.pic:'../../../static/images/avatar.png'" style="width: 100%;height: 100%;" mode="aspectFit"></image>
                        </view>
                    </view>
        ...
        <refresh ref="refresh" @dropOpen="dropOpen" @pullOpen="pullOpen" :drop="true" :pull="true">
            <view class="myDynamic" :style="{height: myDynamicViewH + 'px'}">
                ...
                <view class="dynamicList">
                    <dynamicCard v-for="(item,index) in dynamicList" :key="index" :dynamicObj="item" :currentPageType="'mine'"></dynamicCard>
                </view>
            </view>
        </refresh>
    </view>
