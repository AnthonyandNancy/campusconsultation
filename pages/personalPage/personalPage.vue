	...
	<view class="box">
		<view class="userDetail">
			...
			<view class="common">
					...
					<view class="commonRight"><u-avatar :src="userAvater" class="u_avater"></u-avatar></view>
			</view>
<!--			<view class="common">-->
			...
			<view class="common">
				...
				<view class="commonRight">
					<view @click="clickSex" class="sex">
						{{chooseSex}}
						<u-picker :range="sex" @cancel="cancelSex" @confirm="confirmSex" mode="selector" range-key="value" v-model="showSex"></u-picker>
					</view>
				</view>
			</view>
			<view class="common">
				<view class="commonLeft">年龄</view>
				<view class="commonRight"><u-input :border="false" :maxlength="2" :type="text" input-align="right" placeholder="请输入你的年龄" v-model="personalAge" type="number" :clearable="false"/></view>
			</view>
			<view class="common">
