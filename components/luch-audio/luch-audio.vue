<template>
	<view class="audio-warp">
		<view :class="{ hasbg: !poster }" class="cover-warp">
			<image :src="poster" class="cover-img" v-if="poster"></image>
			<view :class="{ pause: play }" @click="handleBtnClick" class="play-btn"></view>
		</view>
