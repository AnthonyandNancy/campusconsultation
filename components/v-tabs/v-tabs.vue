<template>
  <view :style="{ height: height }" class="v-tabs">
    <scroll-view :scroll-left="scrollLeft" :show-scrollbar="false" class="scroll-view" scroll-with-animation scroll-x style="width: auto; height: 100%; overflow: hidden;">
